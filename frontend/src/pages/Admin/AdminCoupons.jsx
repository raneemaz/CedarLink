  ...
  return (
    <div>
      ...
      <section className="mb-10">
        <h2 className="mb-3 text-small font-semibold uppercase tracking-wide text-ink-muted">
      ...
      <section>
        <h2 className="mb-1 text-small font-semibold uppercase tracking-wide text-ink-muted">
        ...
        {storeScoped.length === 0 ? (
          <p className="rounded-card border border-line bg-paper-raised p-10 text-center text-small text-ink-muted">
