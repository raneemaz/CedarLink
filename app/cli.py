...
# name, description, price, stock, category — grouped by store below.
_STORE_SPECS = (
    {
        ...
        "active": True,
        "products": (
            ("Zaatar Blend 200g", "House wild-thyme blend with sumac and "
             "sesame.", 3.50, 40, "Food"),
            ("Lebanese Extra Virgin Olive Oil 1L", "Cold-pressed, single "
             "-estate from the Koura hills.", 12.00, 25, "Food"),
            ("Baklava Assortment (12 pcs)", "Walnut and pistachio, layered "
             "and soaked in orange-blossom syrup.", 9.00, 0, "Food"),
            ("Arabic Coffee with Cardamom 250g", "Finely ground, medium "
             "roast.", 6.50, 30, "Food"),
            ("Pomegranate Molasses 500ml", "Thick, tart, no added sugar.",
             4.25, 18, "Food"),
            ("\"Beirut Nightingale\" - Poems", "A bilingual pocket "
             "collection by a local press.", 13.00, 20, "Books"),
        ),
    },
    {
        ...
        "active": True,
        "products": (
            ("Hand-Embroidered Abaya", "Black crepe with tone-on-tone "
             "cuff embroidery.", 45.00, 12, "Clothes"),
            ("Cotton Keffiyeh Scarf", "Classic weave, generous size.",
             8.00, 50, "Clothes"),
            ("Linen Summer Shirt", "Breathable, relaxed fit, coconut "
             "buttons.", 22.00, 20, "Clothes"),
            ("Hand-Knit Wool Scarf", "Undyed highland wool.", 15.50, 0,
             "Clothes"),
            ("Full-Grain Leather Belt", "Vegetable-tanned, solid brass "
             "buckle.", 18.00, 15, "Clothes"),
        ),
    },
    {
        ...
        "active": True,
        "products": (
            ("USB-C Fast Charger 30W", "Compact GaN charger, foldable "
             "pins.", 14.99, 35, "Electronics"),
            ("Wireless Earbuds (BT 5.3)", "In-ear, USB-C case, ~6h per "
             "charge.", 29.90, 22, "Electronics"),
            ("Power Bank 10000mAh", "Dual output, pass-through charging.",
             24.50, 16, "Electronics"),
            ("LED Desk Lamp (Dimmable)", "Three colour temperatures, "
             "USB port in the base.", 19.00, 10, "Electronics"),
            ("Braided HDMI Cable 2m", "4K/60Hz, gold-plated ends.", 6.75,
             40, "Electronics"),
            ("\"Arabic Grammar Made Simple\"", "A workbook for adult "
             "learners.", 9.50, 25, "Books"),
        ),
    },
    {
        ...
        "active": False,
        "products": (
            ("Damascus Rose Water Toner 200ml", "Single-ingredient, "
             "steam-distilled.", 7.50, 28, "Beauty"),
            ("Pure Argan Hair Oil 100ml", "Cold-pressed, unscented.",
             16.00, 14, "Beauty"),
            ("Olive & Laurel Aleppo Soap", "Traditional cure, ~20% "
             "laurel.", 4.00, 45, "Beauty"),
        ),
    },
)
...
def seed():
    ...
    for name in ("Food", "Clothes", "Electronics", "Books", "Beauty"):
        category, _ = _get_or_create(
            Category,
            {"description": f"{name} from local Lebanese stores."},
            name=name,
        )
    ...
    for spec in _STORE_SPECS:
        ...
        for name, description, price, stock, category_name in spec[
            "products"
        ]:
